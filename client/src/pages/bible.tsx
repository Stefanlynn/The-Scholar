    ...
    <TooltipProvider>
      <div className="flex h-screen overflow-hidden">
        ...
        <Dialog open={!!selectedVerse} onOpenChange={() => setSelectedVerse(null)}>
          <DialogContent className="bg-[var(--scholar-darker)] border-[var(--scholar-gold)]/20 text-white max-w-5xl w-[90vw] max-h-[90vh] overflow-y-auto mx-auto my-8 rounded-xl shadow-2xl">
        ...
        <Dialog open={showScholarDialog} onOpenChange={setShowScholarDialog}>
          <DialogContent className="bg-[var(--scholar-dark)] border-[var(--scholar-gold)]/30 text-white max-w-4xl w-[calc(100vw-3rem)] sm:w-[90vw] max-h-[calc(100vh-4rem)] overflow-y-auto m-6 sm:mx-auto sm:my-8 rounded-xl shadow-2xl [&>button[aria-label='Close']]:!hidden [&>button]:!hidden">
            <DialogHeader>
