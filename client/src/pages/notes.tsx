        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-6 pb-20 md:pb-6">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid w-full grid-cols-3 bg-[var(--scholar-darker)] h-12 md:h-10">
              ...
              <TabsTrigger value="sermon" className="data-[state=active]:bg-[var(--scholar-gold)] data-[state=active]:text-black flex-col md:flex-row px-2 md:px-4 text-xs md:text-sm">
                <MessageSquareText className="h-4 w-4 md:mr-2" />
                <span className="mt-1 md:mt-0 text-center">Sermon Workspace</span>
              </TabsTrigger>
            </TabsList>
