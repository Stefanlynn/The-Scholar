...
`;
  ...
  const aiEnhanceMutation = useMutation({
    ...
    onSuccess: (data: any, variables) => {
      ...
      toast({ title: "Content enhanced by The Scholar" });
    },
    onError: () => {
                  ...
                  <Card className="bg-[var(--scholar-dark)] border-gray-700">
                    <CardHeader>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mb-4">
                        <div
                          onClick={() => !aiEnhanceMutation.isPending && handleAIEnhancement("expand")}
                        ...
                        >
                          ...
                          <div className="text-xs font-medium">
                            {aiEnhanceMutation.isPending ? "Expanding..." : "Expand Point"}
                          </div>
                          {selectedText && !aiEnhanceMutation.isPending && <div className="text-xs text-blue-300 mt-1">({selectedText.length} chars)</div>}
                        </div>
                        
                        <div
                          onClick={() => !aiEnhanceMutation.isPending && handleAIEnhancement("rewrite")}
                          className={`p-2 rounded-lg border cursor-pointer transition-all text-center ${
                            aiEnhanceMutation.isPending 
                              ? "border-gray-600 text-gray-500 cursor-not-allowed" 
                        ...
                        >
                          ...
                          <div className="text-xs font-medium">
                            {aiEnhanceMutation.isPending ? "Rewriting..." : "Rewrite Clearly"}
                          </div>
                          {selectedText && !aiEnhanceMutation.isPending && <div className="text-xs text-green-300 mt-1">({selectedText.length} chars)</div>}
                        </div>
                        
                        <div
                          onClick={() => !aiEnhanceMutation.isPending && handleAIEnhancement("add_verse")}
                          className={`p-2 rounded-lg border cursor-pointer transition-all text-center ${
                            aiEnhanceMutation.isPending 
                              ? "border-gray-600 text-gray-500 cursor-not-allowed" 
                        ...
                        >
                          ...
                          <div className="text-xs font-medium">
                            {aiEnhanceMutation.isPending ? "Finding Verse..." : "Add Verse"}
                          </div>
                          {selectedText && !aiEnhanceMutation.isPending && <div className="text-xs text-purple-300 mt-1">({selectedText.length} chars)</div>}
                        </div>
                        
                        <div
                          onClick={() => !aiEnhanceMutation.isPending && handleAIEnhancement("add_illustration")}
                          className={`p-2 rounded-lg border cursor-pointer transition-all text-center ${
                            aiEnhanceMutation.isPending 
                              ? "border-gray-600 text-gray-500 cursor-not-allowed" 
                        ...
                        >
                          ...
                          <div className="text-xs font-medium">
                            {aiEnhanceMutation.isPending ? "Creating Story..." : "Add Illustration"}
                          </div>
                          {selectedText && !aiEnhanceMutation.isPending && <div className="text-xs text-orange-300 mt-1">({selectedText.length} chars)</div>}
                        </div>
                      </div>
                    </CardHeader>
                    <CardContent>
