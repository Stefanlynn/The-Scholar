...
`;
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden bg-gradient-to-br from-[var(--scholar-darker)] to-[var(--scholar-dark)]">
        {/* Modern Hero Header */}
        <div className="bg-gradient-to-r from-[var(--scholar-dark)] via-gray-900 to-[var(--scholar-dark)] border-b border-gray-700/50 px-4 md:px-8 py-8">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div className="flex items-center space-x-4">
                <div className="w-16 h-16 bg-gradient-to-br from-[var(--scholar-gold)] to-yellow-600 rounded-2xl flex items-center justify-center shadow-xl">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-lg mt-1">Capture insights, build sermons, and grow in wisdom</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <h2 className="hidden text-lg md:text-xl font-semibold text-white">Notes</h2>
              <PageHelp 
                pageName="Notes"
                helpContent={{
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mt-6">
              <div className="relative flex-1 max-w-lg">
                ...
                <Input
                  type="text"
                  placeholder="Search notes, journals, and sermons..."
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="bg-black/20 backdrop-blur-sm border-gray-600/50 text-white placeholder-gray-400 pl-12 h-12 rounded-xl focus:ring-2 focus:ring-[var(--scholar-gold)]/50"
                />
              </div>
              <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogTrigger asChild>
                  <Button 
                    className="bg-gradient-to-r from-[var(--scholar-gold)] to-yellow-500 text-black hover:from-yellow-400 hover:to-yellow-600 font-semibold px-6 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 h-12"
        ...
        {/* Main Content Area */}
        <div className="flex-1 overflow-y-auto scroll-smooth px-4 md:px-8 py-6 pb-20 md:pb-6">
          <div className="max-w-7xl mx-auto">
            <Tabs value={activeTab} onValueChange={(value) => {
              setActiveTab(value);
              window.scrollTo({ top: 0, behavior: 'smooth' });
            }} className="w-full">
              <TabsList className="grid w-full grid-cols-3 bg-black/30 backdrop-blur-sm border border-gray-700/50 rounded-2xl h-14 p-1 shadow-lg">
                <TabsTrigger value="notes" className="data-[state=active]:bg-[var(--scholar-gold)] data-[state=active]:text-black data-[state=active]:shadow-lg flex-col md:flex-row px-3 md:px-4 text-xs md:text-sm font-medium rounded-xl transition-all duration-200">
                  <FileText className="h-4 w-4 md:mr-2" />
                  <span className="mt-1 md:mt-0">Study Notes</span>
                </TabsTrigger>
                <TabsTrigger value="journal" className="data-[state=active]:bg-[var(--scholar-gold)] data-[state=active]:text-black data-[state=active]:shadow-lg flex-col md:flex-row px-3 md:px-4 text-xs md:text-sm font-medium rounded-xl transition-all duration-200">
                  <PenTool className="h-4 w-4 md:mr-2" />
                  <span className="mt-1 md:mt-0">Daily Journal</span>
                </TabsTrigger>
                <TabsTrigger value="sermon" className="data-[state=active]:bg-[var(--scholar-gold)] data-[state=active]:text-black data-[state=active]:shadow-lg flex-col md:flex-row px-3 md:px-4 text-xs md:text-sm font-medium rounded-xl transition-all duration-200 relative">
